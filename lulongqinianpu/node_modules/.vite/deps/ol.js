...
function parsePaletteArgs(encoded, context) {
  ...
  for (let i = 0; i < parsedColors.length; i++) {
    const color = parse2(colors2[i], context, ColorType);
...
function drawTextOnPath(flatCoordinates, offset2, end, stride, text, startM, maxAngle, scale4, measureAndCacheTextWidth2, font, cache3, rotation) {
...
export {
  ...
  Image_default2 as ImageWrapper,
